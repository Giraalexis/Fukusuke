...
public class EmpleadoDAO {
    ...
    public ArrayList<Empleado> buscarEmpleado(String nombre) throws SQLException{
        ...
        try {
            String sql = "select * from api_employee where name = ?";
    ...
    public void editarEmpleado(Empleado empleado) throws SQLException{
        ...
        try {
            ...
            stmt.setInt(8, empleado.getCommune_id());
            stmt.setInt(8, empleado.getRol_id());
            stmt.setInt(8, empleado.getSex_id());
    ...
    public void eliminarproducto(Empleado empleado) throws SQLException{
